...
-- Trains 1-4 rattaché à des trajets, trains 5-9 rattaché à des gares
...
-- 3 niveaux de risque différents de 1 à 3
...
-- Différents incidents qui permettent de tester q6view.sql unitairement
